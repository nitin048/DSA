# 🌳 Lowest Common Ancestor in Binary Tree - Complete Guide from Scratch

## 📚 Table of Contents

1. [What is Lowest Common Ancestor in Binary Tree?](#-what-is-lowest-common-ancestor-in-binary-tree)
2. [Why Lowest Common Ancestor in Binary Tree?](#-why-lowest-common-ancestor-in-binary-tree)
...
### **Concept Overview:**
Finding Lowest Common Ancestor Node in Binary Tree.
...
## 💡 Why Lowest Common Ancestor in Binary Tree?
...
- **LCA:** Shared ancestor node at lowest depth.
- Check left/right subtrees recursively. Meeting node is LCA.
...
- **Returns null if neither node is present in the subtrees.**
