# 🗂️ Recover BST - Complete Guide from Scratch

## 📚 Table of Contents

1. [What is Recover BST?](#-what-is-recover-bst)
2. [Why Recover BST?](#-why-recover-bst)
...
- **Swap the node values (`swap(first->val, second->val)`) after search traversal completes.**
