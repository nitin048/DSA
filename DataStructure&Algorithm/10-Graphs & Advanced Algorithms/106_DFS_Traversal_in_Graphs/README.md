# 🕸️ DFS Traversal in Graphs - Complete Guide from Scratch

## 📚 Table of Contents

1. [What is DFS Traversal in Graphs?](#-what-is-dfs-traversal-in-graphs)
2. [Why DFS Traversal in Graphs?](#-why-dfs-traversal-in-graphs)
...
## 🎯 What is DFS Traversal in Graphs?
...
- **DFS:** Explores paths recursively before backtracking.
- Uses a recursion stack or an iterative stack buffer.
...
- **Ideal for connectivity searches and cycle checks.**
